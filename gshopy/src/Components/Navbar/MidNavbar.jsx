...
// function MidNavbar({onWomen,onMen})
// {
//         return(
//             <div>
...
//                 <Text fontSize="12px" fontFamily="Montserrat,sans-serif" fontWeight="bold" onClick={onWomen}>WOMEN</Text>
//                 <Text fontSize="12px" fontFamily="Montserrat,sans-serif" fontWeight="bold" onClick={onMen}>MEN</Text>
